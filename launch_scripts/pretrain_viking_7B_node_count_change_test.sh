...
#SBATCH --job-name=nodecount_test
#SBATCH --nodes=8
...
#SBATCH --output=logs-7B_high_eps/%j-7B_high_eps_nodecount.out
#SBATCH --error=logs-7B_high_eps/%j-7B_high_eps_nodecount.err
...
LOAD_PATH=/scratch/project_462000086/viking-v2/7B_high_eps
SAVE_PATH=/scratch/project_462000086/risto/tmp_checkpoints/
